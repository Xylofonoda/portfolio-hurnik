...
const MenuItems: React.FunctionComponent<MenuItemsProps> = (props) => {
	const MOBILE_CLASSES = `text-2xl font-semibold text-white my-4 transform transition-transform duration-300 ${
		props.menuOpen ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"
	}`;
